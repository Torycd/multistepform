    ...
    <div className="py-10 h-full flex justify-center items-center">
      <div className="flex flex-col space-y-5 justify-center items-center">
        ...
        <div className="space-y-4">
          <h2 className="font-bold text-3xl text-center">Thank you!</h2>
          <h4 className="opacity-70 text-center lowercase">
            Thanks for Conforming your scubsvriptioon! WE HOPE YOU HAVE FUN
            USING OUT PLATFORM. IF YOU EVER NEED SUPPPORT, PLEASE FEEL FREE TO
            email us at support@gmail.com
          </h4>
        </div>
      </div>
    </div>
