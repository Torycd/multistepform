...
export default function HomePage() {
  ...
  return (
    <div className="bg-slate-600 flex align-center w-dvh h-[100%] font-Ubuntu md:p-10">
      <div className="w-full h-full md:w-[1080px] sm:bg-white rounded-lg sm:mx-auto md:p-10">
        <div className="w-dvh flex flex-col md:flex-row md:gap-10 h-full relative">
          ...
          {/* Main content */}
          <div className="w-dvh h-full -translate-y-[10%] mt-6 sm:-translate-y-0 rounded-lg mx-6 md:w-[60%] z-10  bg-white px-10">
